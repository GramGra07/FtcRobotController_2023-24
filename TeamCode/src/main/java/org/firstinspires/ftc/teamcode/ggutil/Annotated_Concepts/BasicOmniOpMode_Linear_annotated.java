package org.firstinspires.ftc.teamcode.ggutil.Annotated_Concepts;// gets the package name you are currently in
...
public class BasicOmniOpMode_Linear_annotated extends LinearOpMode {//this means that this java class can use anything from linear op mode
    ...
    public void runOpMode() {
        ...
        leftFrontDrive = hardwareMap.get(DcMotor.class, "left_front_drive");   //initialized the variables, the "" is the name on your control hub
