...
@TeleOp(name = "mecanumSample", group = "Robot")
@Disabled
public class MecanumDrivingSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(
                new Motor(hardwareMap, "motorFrontLeft"),
                new Motor(hardwareMap, "motorFrontRight"),
                new Motor(hardwareMap, "motorBackLeft"),
                new Motor(hardwareMap, "motorBackRight")
        );
